...
| [news_collect](./skills/news_collect) | 一站式资讯收集工具：抓取文章 → 大模型生成摘要 → 推送到飞书 |
| [wechat-article-writer](./skills/wechat-article-writer) | 技术公众号文章写作助手，支持完整文章生成、爆款标题优化、结构模板选择 |
| [wechat-fetch](./skills/wechat-fetch) | 抓取微信公众号文章内容，提取标题、作者、发布时间、正文和图片 |
| [wechat-to-xiaohongshu](./skills/wechat-to-xiaohongshu) | 将公众号文章保存到本地并转换为小红书风格文案，同时生成封面图设计文案 |
| [wechat-url-to-markdown](./skills/wechat-url-to-markdown) | 将微信公众号链接内容保存为本地 Markdown 格式 |
