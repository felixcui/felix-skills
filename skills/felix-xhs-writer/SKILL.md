...
/felix-xhs-writer ~/Desktop/article.md

# 指定输出目录
/felix-xhs-writer ~/Desktop/article.md --output-dir ~/Desktop/xhs
```
...
📁 文件已保存至:
- 小红书文案: `felix-xhs-writer/output/YYYY-MM-DD_Claude Code神器推荐_xhs.md`
- 封面图设计: `felix-xhs-writer/output/YYYY-MM-DD_Claude Code神器推荐_cover-points.md`
```
