...
NOTEBOOK_ID = "f75a961b-4b74-4dc1-a604-534119fe27a7"  # "AI 资讯 V3" notebook (V2 已满 300 sources)
...
/opt/homebrew/bin/python3.14 -m notebooklm source add /tmp/ascii-name.md --notebook "f75a961b-4b74-4dc1-a604-534119fe27a7"
...
# ✅ 可靠 — 始终使用完整 ID
notebooklm source list --notebook "f75a961b-4b74-4dc1-a604-534119fe27a7"
```
...
/opt/homebrew/bin/python3.14 -m notebooklm source add /tmp/english-name.md --notebook "f75a961b-4b74-4dc1-a604-534119fe27a7"
```
